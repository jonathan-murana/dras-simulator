...
public class HEU_HIGHEST_DEADLINE_BAR_MIPS_WITH_CORES extends HEU {
	// ORDER BY ID
	public static int [] schedule(
		 ...
		 int result[] = new int[problem.getD().length];
	      Arrays.setAll(result, i -> 2000000 * problem.getD()[i] / problem.getMIPS()[i]);
