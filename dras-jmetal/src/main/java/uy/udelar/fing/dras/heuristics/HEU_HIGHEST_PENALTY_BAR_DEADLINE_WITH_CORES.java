...
public class HEU_HIGHEST_PENALTY_BAR_DEADLINE_WITH_CORES extends HEU {
	// ORDER BY ID
	public static int [] schedule(
		 ...
		 int result[] = new int[problem.getLoss().length];
	      Arrays.setAll(result, i -> 2000000 * problem.getLoss()[i] / problem.getD()[i]);
		  int [] task_sorted_by_at = Utils.sort_by_max(result);
